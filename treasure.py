...
print(
    "You have heard about this treasure, hidden in a mysterious pine forest from an old story, told to you by your grandpa...\n")
...
~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
 ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
    ...
    transportation = input(
        'Type "boat" if you want to build a boat or type "swim" if you are willing to take a risk so that you will be the first to the treasure! ').lower()
...
*******************************************************************************
 ...
 jgs^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
            ''')
            print(
                "Oh no! You entered the wrong door. The room that you are in is on fire.\n Your progress ends here...")
        elif door == "blue":
            print(r'''
                   (    )
                  ((((()))
        ...
        \(  \\.-' ( /    \/    \)
         '  ()) _'.-|/\/\/\/\/\|
          ...
          _____ //,/" ___ ((( ', ___
            ...
            ''')
            print(
                "Yikes! The room is full of beasts. They started chomping onto you. That is a sad way to lose... \n Progress = rip...")
        else:
            print(r'''
             _                   _     _             
| |                 | |   (_)            
...
|_|\__,_|\__,_|\__, |_| |_|_|_| |_|\__, |
            ...
            ''')
            print(
                "You want to trick the game, huh? You think you are smart by not choosing one of the specified doors?")
     ...
     jgs     \ \, ~   -   ~
        ...
        ''')
        print(
            "You didn't even get into the river properly before you were pulled down by an octopus and bitten by piranhas. "
            "Better luck next time!")
else:
    print("This is not the right way:\n"
          "Let's play a game:\n"
          "You find a magical coconut:\n")
    decision = input("Do you want to eat it? It may have ^magical^ powersss... or maybe not...\n"
          'Type "yes" if you want to take a risk or "no" if you are afraid. ').lower()
    if decision == "yes":
        print("The magical coconut is poisonous, you fall to the ground... GAME OVER!\n")
    else:
        print("You have decided to not eat it, it may be a wise choice...\n")
        print("After wandering all day through the spooky forest, you sadly pass out from dehydration...\n"
              "While unconscious you get bitten by a venomous $python... GAME OVER!\n")
